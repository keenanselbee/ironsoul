...
$b612 = Join-Path $repo "reference\B612 - Full\Source\Scripts"
$skyuiStubs = Join-Path $repo "dev\papyrus-stubs\skyui"
...
$imports = "$sourceDir;$b612;$skyuiStubs;$skse;$papyrusUtil;$stock"
...
Assert-DirectoryExists $b612 "B612 source import"
Assert-DirectoryExists $skyuiStubs "SkyUI compile stub import"
