...
Scriptname _DS_DN_QF_DeathSquad_Lumbermill Extends Quest Hidden
...
Function Fragment_0()
;BEGIN CODE
dsDnok.SquadReport(dsDnok.SQUAD_LUMBERMILL, GetName(), Alias_TravelDestinationLocation.GetLocation(), None, Alias_SpawnMarker.GetReference())
;END CODE
EndFunction
;END FRAGMENT
