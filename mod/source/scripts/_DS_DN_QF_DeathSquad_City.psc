...
Scriptname _DS_DN_QF_DeathSquad_City Extends Quest Hidden
...
Function Fragment_0()
;BEGIN CODE
dsDnok.SquadReport(dsDnok.SQUAD_CITY, GetName(), Alias_TravelDestinationLocation.GetLocation(), Alias_TravelDestinationRef.GetActorRef(), Alias_SpawnMarker.GetReference())
;END CODE
EndFunction
;END FRAGMENT
