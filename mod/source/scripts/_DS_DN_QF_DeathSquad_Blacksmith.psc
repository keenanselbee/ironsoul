...
Scriptname _DS_DN_QF_DeathSquad_Blacksmith Extends Quest Hidden
...
Function Fragment_0()
;BEGIN CODE
dsDnok.SquadReport(dsDnok.SQUAD_BLACKSMITH, GetName(), None, Alias_TravelDestinationRef.GetActorRef(), Alias_SpawnMarker.GetReference())
;END CODE
EndFunction
;END FRAGMENT
